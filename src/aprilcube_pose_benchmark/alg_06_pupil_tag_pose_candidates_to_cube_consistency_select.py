...
from aprilcube_pose_benchmark.common_pose import tag_pose_candidate_cube_consistency
...
ALGORITHM_NAME = "alg_06_pupil_tag_pose_candidates_to_cube_consistency_select"


def algorithm_fn(detector: Any, native_detector: Any, tags: list[Any], gray: np.ndarray, context: dict[str, Any]) -> dict[str, Any]:
    """每个 tag 保留多个平面 pose 候选，用 cube 一致性选择最一致的候选组。"""
    return tag_pose_candidate_cube_consistency(detector, tags)
